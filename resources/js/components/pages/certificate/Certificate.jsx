...
import cerLogo from '../../../../../public/img/cerlogo.jpg'
import person from '../../../../../public/img/per.jpg'
...
function Certificate() {
    ...
    // const getCer = () => {
    //     setLoading(true);
    //     axiosClient.get('/trCer').then(({data}) => {
    //         setLoading(false)
    //         setCer(data.data)
    //         console.log(data)
    //     }).catch(()=>{
  ...
  return (
    <>
        <div className='flex justify-between items-center my-8 w-[90%] m-auto'>
            <h1 className=' text-4xl text-accent'>Certificate</h1>
            <DownloadPDF downloadFileName="CustomPdf" rootElementId="pdf"  />
        </div>

        <div className='border-2 rounded border-accent my-8 mx-auto w-fit bg-white text-black'>
            <div id="pdf" className='w-[993px] h-[1404px] p-3 mx-auto'>
                <div className='flex flex-row justify-between items-center mb-8 mx-6'>
                    ...
                    <div className='text-center'>
                        <h2 className=' text-4xl font-sans'>2022 ERÜYÖS</h2>
                        <h3 className='text-3xl font-sans'>SINAV SONUÇ BELGESİ</h3>
